...
CREATE TABLE datos_floristeria IF NOT EXISTS (
	id BIGINT UNSIGNED NOT NULL PRIMARY KEY,
    nombre VARCHAR(120) NOT NULL
);
    
CREATE TABLE producto IF NOT EXISTS (
	id BIGINT UNSIGNED NOT NULL PRIMARY KEY,
    nombre VARCHAR(120) NOT NULL,
    precio FLOAT,
    tipo VARCHAR(30),
...
CREATE TABLE arbol IF NOT EXISTS(
	id BIGINT UNSIGNED NOT NULL,
    altura FLOAT,
    FOREIGN KEY (id) REFERENCES producto(id)
);

CREATE TABLE flor IF NOT EXISTS(
	id INT UNSIGNED NOT NULL,
    color VARCHAR(30),
    FOREIGN KEY (id) REFERENCES producto(id)
);

CREATE TABLE decoracion IF NOT EXISTS(
	id BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE producto_ticket IF NOT EXISTS (
